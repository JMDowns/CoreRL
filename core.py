...
def main():
    ...
    objects = [[Entity(x, y, ' ', libtcod.red, camera, True) for y in range(map_height)] for x in range(map_width)]
    ...
    while not libtcod.console_is_window_closed():
        ...
        render_all(con, entities, camera, game_map, screen_width, screen_height, colors)
        
        libtcod.console_flush()

        clear_all(con, game_map.objects, camera)
